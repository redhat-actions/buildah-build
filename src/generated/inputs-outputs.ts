...
export enum Inputs {
    ...
    /**
     * Set to true to squash image layers into a single layer. For Containerfile builds this squashes all layers; for scratch builds this squashes only newly added layers.
     * Required: false
     * Default: "true"
     */
    SQUASH = "squash",
